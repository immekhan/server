...
public class AccountResourceIntTest {
    ...
    @Mock
    UserUtilityService absUserUtilityService;
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService ,absUserUtilityService);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService , absUserUtilityService);
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), validUser.getLogin(), validUser.getPassword(), validUser.getFirstName(), validUser.getLastName(),
            "alicejr@example.com", true, validUser.getImageUrl(), validUser.getLangKey(), "0", validUser.getCreatedDate(), "0", validUser.getLastModifiedDate(), validUser.getAuthorities());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), "johnjr", validUser.getPassword(), validUser.getLogin(), validUser.getLastName(),
            validUser.getEmail(), true, validUser.getImageUrl(), validUser.getLangKey(), "0", validUser.getCreatedDate(), "0", validUser.getLastModifiedDate(), validUser.getAuthorities());
        ...
        final ManagedUserVM userWithUpperCaseEmail = new ManagedUserVM(validUser.getId(), "johnjr", validUser.getPassword(), validUser.getLogin(), validUser.getLastName(),
                validUser.getEmail().toUpperCase(), true, validUser.getImageUrl(), validUser.getLangKey(), "0", validUser.getCreatedDate(), "0", validUser.getLastModifiedDate(), validUser.getAuthorities());
